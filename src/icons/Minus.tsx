...
type MinusIconProps = Omit<BaseIconProps, "src" | "alt" | "children">;

export default function MinusIcon({ ...rest }: MinusIconProps) {
  return (
    <BaseIcon {...rest}>
      <svg
        width="24"
